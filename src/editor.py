...
def update_line_numbers(event=None):
    ...
    # Borrar solo los números de línea previos
    ...
    line_numbers_panel.yview_moveto(current_yview[0])
    text_area.yview_moveto(current_yview[0])
...
# Actualización de números de línea al modificar el texto
